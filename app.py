...
goal_rules = {
    "Networking": [
        ...
        "ネットワーク", "人脈", "つながり", "繋がり", "交流", "コネクション",
    ],
    "Career and Job Support": [
        "job", "career", "employment", "work opportunity",  "work experience",
    "professional experience","internship experience","intern",
        "仕事", "就職", "転職", "キャリア", "求人", "就活", "働く",  "実務経験を得たい","インターン経験","インターン",
    ],
    "Learning and Skills": [
        "learn", "skill", "training", "technical", "data", "coding","gain experience","get experience","build experience","practical experience","hands-on experience",
        "学ぶ", "学習", "スキル", "研修", "勉強", "技術", "データ", "プログラミング","経験を積みたい","経験を積む","実践的な経験",
    ],
    "Mentorship": [
        "mentor", "guidance", "advisor","mentee",
        "メンター", "メンタリング", "指導", "助言", "相談", "アドバイス",
    ],
    "Entrepreneurship": [
        "business", "startup", "entrepreneur", "founder",
        "ビジネス", "スタートアップ", "起業", "創業", "事業", "経営",
    ],
    "Community Contribution": [
        "community", "contribute", "volunteer", "support others",
        "コミュニティ", "地域", "貢献", "ボランティア", "支援", "サポート",
    ],
}
...
industry_rules = {
    ...
    "Technology and Data": [
        "technology","data","software","developer","coding","engineer","computer science","information technology","it","programming","web development","app development",
        "テクノロジー","データ","ソフトウェア","開発","プログラミング","エンジニア","技術","コンピュータサイエンス","情報技術","ウェブ開発","アプリ開発",
    ],

    "Business and Entrepreneurship": [
        "business","startup","entrepreneur","founder","operations","business management","general management","operations management","business administration","ビジネス",
        "スタートアップ",
        "起業",
        "創業",
        "経営",
